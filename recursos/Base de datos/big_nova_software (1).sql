...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-04-2021 a las 19:09:57
...
--
ALTER TABLE `objects_initials`
  MODIFY `obin_auto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `objects_users`
  MODIFY `obus_auto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
