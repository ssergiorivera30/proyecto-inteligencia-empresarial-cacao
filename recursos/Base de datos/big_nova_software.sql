...
(26, 2, 'Proyecto de cacao la Angostura', '...', NULL, '26-2107130907280728231.jpg', '[{\"input\":{\"name\":\"L\\u00edder\",\"type\":\"text\",\"required\":false,\"placeholder\":\"\",\"value\":\"Ingeniera Leidy Machado\",\"token\":\"c266224261625629326865781_26\",\"minlength\":\"\",\"maxlength\":\"\",\"size\":\"\",\"min\":\"\",\"max\":\"\",\"edit\":0,\"options\":[],\"sub_option_other\":0,\"sub_options_types\":{\"option1\":{\"type\":\"text\"},\"option2\":{\"type\":\"file\"}},\"sub_options_values\":[]}}]', '2021-07-06', '2021-07-06', '2021-07-13 19:14:28', 1, 1),
...
(28, 1, 'Team Actividades Sergio Rivera', 'Team para la gestión de actividades de Sergio Rivera', NULL, '28-2107130607420742279.jpg', NULL, '2021-07-13', '2021-07-13', '2021-07-13 23:56:32', 1, 1),
(32, 1, 'Equipo vigilancia científica y tecnológica  - NOVA', 'La vigilancia tecnológica se refiere al monitoreo y recolección, permanente y sistemática, de datos relevantes del entorno científico y tecnológico. Estos datos son analizados y codificados en información útil, en un proceso que se lo denomina “inteligencia estratégica”', NULL, '32-2107131107370737954.jpg', NULL, '2021-07-13', '2021-07-13', '2021-07-13 21:16:37', 1, 1);
...
(1, '1.jpg', '2021-04-25', '04:27:50', '2021-07-13 02:27:51'),
...
--
-- Metadatos para la tabla log_user_sesions_success
--

--
-- Metadatos para la tabla system_status
--

--
-- Metadatos para la tabla tbl_services
--
...
--
-- Metadatos para la tabla tbl_type_service
--

--
-- Metadatos para la tabla users_avatars
--

--
-- Metadatos para la tabla users_credentials
--

--
-- Metadatos para la tabla users_keys
--

--
-- Metadatos para la tabla user_count_type
--

--
-- Metadatos para la tabla user_data_personals
--

--
-- Metadatos para la tabla z3_entity_4
--

--
-- Metadatos para la tabla z3_entity_27
--

--
-- Metadatos para la base de datos big_nova_software
--
