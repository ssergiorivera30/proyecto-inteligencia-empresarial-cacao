...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2021 a las 23:35:12
...
(35, 100, '34', '66', 'INFORME', 'Informe de Evidencias', 'Informe de Horas Trabajadas en la Unidad Productiva', '6', '12', '2019-12-10 04:12:50', '2019-12-10 15:24:50', 1, 1);
...
(11, 1023130, '2019-20', 'Análisis y Desarrollo de Sistemas de Información', '2019-01-01 00:00:00', '2019-06-01 00:00:00', '2020-12-01 00:00:00', '100', 0, 0, 0, 0, 0, 1, 0, '2019-06-07 00:00:00', '2019-12-22 16:43:51', 1, 1, NULL, NULL, 1, NULL),
...
(101, '104', 11, '2020-04-17 08:43:21', 1, 0, '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'),
...
(104, '119', 11, '2019-12-06 06:25:18', 1, 1, '', '0000-00-00 00:00:00', '', '0000-00-00 00:00:00'),
...
(117, 118, '9526', '41', 1, 1, '2019-12-06 00:46:18'),
...
--
ALTER TABLE `actividades_drive_url`
  MODIFY `adu_auto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `etapa_archivo`
  MODIFY `eta_id_auto` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT de la tabla `etapa_formatos_asociados`
--
ALTER TABLE `etapa_formatos_asociados`
  MODIFY `efa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `requerimientos_presustentacion`
  MODIFY `rp_auto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `titulacion_rol_asesor`
  MODIFY `tra_auto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `version_trazabilidad`
  MODIFY `vtraz_auto_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
COMMIT;
