<template>
   <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-3">
      <header class="flex items-center justify-between" v-if="this.$router.currentRoute._rawValue.fullPath != '/proyecto/objeto_nuevo/constructor-objeto/'+this.$route.params.id_object">
