  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <form
      ...
      <header class="flex items-center justify-center">
        <h2 class="text-lg leading-6 font-medium text-black">Registrar nuevo objeto de Investigación</h2>
      </header>
...
export default {
  ...
  methods: {
    SaveInitialForm: function () {
      axios
        .post(API_ROUTER.PHP7_CONTROLLER + "objeto_create.php", {
        ...
        .then((response) => {
          ...
          this.$router.replace("/proyecto/objeto_nuevo/constructor-objeto/" + response.data.code);
        });
    },
  },
};
