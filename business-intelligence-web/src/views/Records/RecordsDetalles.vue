<template>
    <div>
        <ServiceToptInfoBasic 
            ...
            :IdService="parseInt(this.$route.params.id_record)" 
                ...
                ServiceToptInfoNav: [
                    {
                        ...
                        Linkroute: '/componente/registrar/'+ this.$route.params.id_record     
                    },
                ],
        ...
        methods: {
            ...
            LoadDataService: function() {
                axios.post(API_ROUTER.PHP7_CONTROLLER + "build-2/2_listar_data.php", {
                    id_service: this.$route.params.id_record,
                }).then((res) => {
