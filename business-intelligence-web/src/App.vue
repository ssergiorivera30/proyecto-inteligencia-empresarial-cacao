<template>
  ...
  <aside class="hidden sm:flex sm:flex-col">
    <a href="#" class="inline-flex items-center justify-center h-20 w-20 bg-gray-100 hover:bg-white-500 focus:bg-gray-800">
      <img src="./assets/sena.webp" class="h-12 w-12" alt="">
    </a>
    <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-100">
      <nav class="flex flex-col mx-4 my-6 space-y-4">
        <router-link to="/" class="inline-flex items-center justify-center py-3 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg">
          <span class="sr-only">Inicio</span>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
        </router-link>
        <router-link to="/proyectos" class="inline-flex items-center justify-center py-3 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg">
       ...
       <router-link to="/dashboard"  class="inline-flex items-center justify-center py-3 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg">
          <span class="sr-only">Messages</span>
          <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
        </router-link>
        <router-link to="/ver" class="inline-flex items-center justify-center py-3 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg">
      ...
      <div class="inline-flex items-center justify-center h-20 w-20">
        <button class="p-3 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg">
  ...
  <div class="flex-grow text-gray-800 ">
    <header class="flex items-center h-15 px-6 sm:px-10 bg-white shadow-sm">
      ...
      <div class="relative w-full max-w-md sm:-ml-2">
        <svg aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" class="absolute h-6 w-6 mt-1 ml-2 text-gray-400">
      ...
      <div class="flex flex-shrink-0 items-center ml-auto" >
        <button class="inline-flex items-center p-2 hover:text-purple-900 rounded-lg focus:outline-none" @click="login()">
          ...
          <span class="h-10 w-10 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
            <img :src="user_photo" alt="user profile photo" class="h-full w-full object-cover">
          </span>
        ...
        <div class="border-l pl-3 ml-3 space-x-1">
          <button class="relative p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full focus:outline-none">
