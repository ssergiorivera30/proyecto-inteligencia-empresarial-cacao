<template>
  ...
  <aside class="hidden sm:flex sm:flex-col">
    <a href="#" class="inline-flex items-center justify-center h-20 w-20 bg-gray-800 hover:bg-white-500 focus:bg-gray-800">
      <img src="./assets/sena-blank.png" class="h-12 w-12" alt="">
    </a>
    <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
      ...
      <div class="inline-flex items-center justify-center h-20 w-20 border-t border-gray-700">
        <button class="p-3 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
