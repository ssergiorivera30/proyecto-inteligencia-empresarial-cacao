...
<template>
  ...
  <aside class="hidden sm:flex sm:flex-col">
    <router-link to="/" class="inline-flex pt-1 justify-center h-10 w-14 bg-gray-100 hover:bg-gray-100 focus:bg-gray-100">
    ...
    <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-100 w-14">
      <nav class="flex flex-col mx-4 my-2 space-y-3">
        ...
        <router-link to="/herraminetas" class="inline-flex items-center justify-center py-2 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg" title="Herramientas">
        ...
        <router-link to="/cuenta" class="inline-flex items-center justify-center py-2 hover:text-purple-900 focus:text-gray-400 focus:text-purple-900 rounded-lg">
    ...
    <header class="flex items-center h-12 px-1 sm:px-10 bg-blue-900 shadow-sm">
      ...
      <div class="flex flex-shrink-0 items-center ml-auto" >
        ...
        <div class="border-l pl-3 ml-3 space-x-1">
          <button class="relative p-2 text-gray-400 hover:text-gray-600 focus:bg-blue-900 focus:text-gray-600 rounded-full focus:outline-none">
          ...
          <button @click="CloseSessionWitchEmail" class="relative p-2 text-gray-400 hover:text-gray-600 focus:bg-blue-900 focus:text-gray-600 rounded-full focus:outline-none">
