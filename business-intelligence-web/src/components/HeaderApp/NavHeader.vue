   ...
   <button class="block sm:hidden relative flex-shrink-0 p-2 mr-2 text-color-text-ui hover:bg-gray-100 hover:text-color-text-ui focus:text-color-text-ui rounded-md">
        ...
        <div class="print-none flex flex-shrink-0 items-center ">
           <a href="javascript:history.back()" class="relative text-white rounded-full focus:outline-none pr-2" >
             <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-color-text-ui" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="print-none flex flex-shrink-0 items-center ml-auto">
          <button class="inline-flex items-center p-2 hover:text-color-text-ui rounded-lg focus:outline-none">
            <span class="sr-only">Menu</span>
            <div class="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span class="text-sm font-semibold text-color-text-ui">{{ user_name }}</span>
            </div>
            ...
            <svg aria-hidden="true" viewBox="0 0 20 20" fill="currentColor" class="hidden sm:block h-6 w-6 text-color-text-ui">
          ...
          <div class="border-l pl-3 ml-3 space-x-1">
            ...
            <button @click="ClickCenterConter"
              ...
              <i v-if="CenterContent == ''" class="text-xl bx bx-exit-fullscreen text-color-text-ui"></i>
              <i v-else class="text-xl bx bx-fullscreen text-color-text-ui"></i>
            </button>
            ...
            <!-- <button @click="CloseSessionWitchEmail"
              ...
              <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-5 w-5 text-color-text-ui">
